...
<div class="section">
  <h1 class="title">
    <?php echo $title; ?> <a class="button is-warning is-rounded is-pulled-right" href="<?php echo base_url(); ?>products/add"><i class="fas fa-plus-circle"></i><span class="p-l-xs is-hidden-smobile">Add Product</span></a>
 </h1>
      ...
      ?><tr>
        ...
        <td><?php  if(!empty($latest_version)){
          ...
          <td><div class="buttons is-centered">
            ...
            $js = 'id="delete_form_'.$product['pd_pid'].'"';
            echo form_open('/products/delete',$js, $hidden); ?>
            <button type="button" data-id="<?php echo $product['pd_pid']; ?>" data-title="product" data-body="Please note that all of the product <b><?php echo $product['pd_name']; ?></b>'s relevant records like (versions, licenses, activations and update download logs) will also be permanently deleted." class="button with-delete-confirmation is-danger is-small" title="Delete Product" style="padding-top: 0px;padding-bottom: 0px;"><i class="fa fa-trash p-r-xs"></i>Delete</button>
            </form>
            </div>
          </td>
        </tr>
