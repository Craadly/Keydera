  ...
  <div class="box">
    <?php 
      ...
      <div class="field">
        ...
        <div class="control">
          <input class="input" type="text" name="version" maxlength="255" value="<?php echo set_value('version'); ?>" placeholder="Product version eg. v1.0.0" required>
        </div>
      </div>
      <div class="field">
        <label class="label">Release Date</label>
        <div class="control">
          <input class="input date-time-picker" type="text" name="released" value="<?php echo set_value('released'); ?>" placeholder="Version release date" required>
        </div>
      </div>
      <div class="field">
        <label class="label">Update Notification/Summary</label>
        <div class="control">
          <input class="input" type="text" name="summary" maxlength="255" value="<?php echo set_value('summary'); ?>" placeholder="e.g. This update brings major improvements, upgrade now!">
        </div>
      </div>
      <div class="field">
      ...
      <div class="columns">
        <div class="column">
           <div class="field">
            <label class="label">Main files (.zip) <small class="tooltip is-tooltip-multiline is-tooltip-right " data-tooltip="These files will be extracted/replaced in the application root so structure it accordingly also make sure you include the updated helper file which has the 'current_version' value changed to the new version." style="font-weight: 400;"><i class="fas fa-question-circle"></i></small></label>
            ...
            echo convert_kb($get_max_upload_size); ?>" data-allowed-file-extensions="zip" accept=".zip" required/>
          </div>
        </div>
        <div class="column">
          <div class="field">
            <label class="label">Sql file (.sql) [Optional] <small class="tooltip is-tooltip-multiline is-tooltip-right " data-tooltip="Add your update SQL file here, It will automatically get imported into your client's database during the update process." style="font-weight: 400;"><i class="fas fa-question-circle"></i></small></label>
