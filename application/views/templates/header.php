...
<html lang="en">
<head>
	<title><?php echo $title ?> - LicenseBox</title>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="robots" content="noindex, nofollow">
	<meta name="theme-color" content="<?php echo (strtolower(LICENSEBOX_THEME)=="classic")?"#4285f4":((strtolower(LICENSEBOX_THEME)=="flat")?"#34495e":"#3F51B5"); ?>">
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/<?php echo LICENSEBOX_THEME; ?>.css?v=lb152" />
