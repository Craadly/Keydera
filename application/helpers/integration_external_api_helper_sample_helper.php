...
define("LB_TEXT_CONNECTION_FAILED", '{[TEXT_CONNECTION_FAILED]}');
define("LB_TEXT_INVALID_RESPONSE", '{[TEXT_INVALID_RESPONSE]}');
define("LB_TEXT_VERIFIED_RESPONSE", '{[TEXT_VERIFIED_RESPONSE]}');
define("LB_TEXT_PREPARING_MAIN_DOWNLOAD", '{[TEXT_PREPARING_MAIN_DOWNLOAD]}');
define("LB_TEXT_MAIN_UPDATE_SIZE", '{[TEXT_MAIN_UPDATE_SIZE]}');
define("LB_TEXT_DONT_REFRESH", '{[TEXT_DONT_REFRESH]}');
define("LB_TEXT_DOWNLOADING_MAIN", '{[TEXT_DOWNLOADING_MAIN]}');
define("LB_TEXT_UPDATE_PERIOD_EXPIRED", '{[TEXT_UPDATE_PERIOD_EXPIRED]}');
define("LB_TEXT_UPDATE_PATH_ERROR", '{[TEXT_UPDATE_PATH_ERROR]}');
define("LB_TEXT_MAIN_UPDATE_DONE", '{[TEXT_MAIN_UPDATE_DONE]}');
define("LB_TEXT_UPDATE_EXTRACTION_ERROR", '{[TEXT_UPDATE_EXTRACTION_ERROR]}');
define("LB_TEXT_PREPARING_SQL_DOWNLOAD", '{[TEXT_PREPARING_SQL_DOWNLOAD]}');
define("LB_TEXT_SQL_UPDATE_SIZE", '{[TEXT_SQL_UPDATE_SIZE]}');
define("LB_TEXT_DOWNLOADING_SQL", '{[TEXT_DOWNLOADING_SQL]}');
define("LB_TEXT_SQL_UPDATE_DONE", '{[TEXT_SQL_UPDATE_DONE]}');
define("LB_TEXT_UPDATE_WITH_SQL_IMPORT_FAILED", '{[TEXT_UPDATE_WITH_SQL_IMPORT_FAILED]}');
define("LB_TEXT_UPDATE_WITH_SQL_IMPORT_DONE", '{[TEXT_UPDATE_WITH_SQL_IMPORT_DONE]}');
...
class KeyderaExternalAPI{
	...
	public function __construct(){ 
		...
		$this->verification_period = 1; // Default value for template
	...
	public function verify_license($time_based_check = false, $license = false, $client = false){
		...
		if($time_based_check && $this->verification_period > 0){
			...
			if(strtotime($today) >= strtotime($_SESSION["{[RND1]}"])){
				$get_data = $this->call_api(
					'POST',
