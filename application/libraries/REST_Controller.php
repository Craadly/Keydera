...
abstract class REST_Controller extends CI_Controller {
    ...
    public function _remap($object_called, $arguments = [])
    {
        ...
        if ($this->config->item('rest_enable_keys') && $use_key && empty($this->rest->key) === FALSE && $this->_check_access($object_called) === FALSE)
        {
            if ($this->config->item('rest_enable_logging') && $log_method)
            {
                $this->_log_request();
     ...
     */
    protected function _check_access($controller_method)
    {
        ...
        return $this->rest->db
                ...
                ->like('endpoints', $controller_method)
